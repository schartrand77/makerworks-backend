...
class EstimateRequest(BaseModel):
    ...
    filament_type: str = Field(..., description="Type of filament (e.g. PLA, PLA MATTE, PETG)")
    filament_colors: List[str] = Field(..., min_items=1, max_items=4, description="List of selected color hex codes")
